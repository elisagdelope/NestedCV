...
def feature_importances_from_shap_values(shap_values, X, names_list=None, n=20):
    """
    Extracts the top n relevant features in an ordered way, given a matrix of shap values
